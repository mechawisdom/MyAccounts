...
import com.mkdevelopment.myaccounts.common.Constant.WRITE_READ_PERMISSION_REQUEST_CODE
...
import com.mkdevelopment.myaccounts.utils.ExportWorker
...
class MainActivity : AppCompatActivity() {
    ...
    private var totalAccountCount = 0
    private var isExportDataClick = true
    private var isBlinkProfile = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainInitialize()
        isBlinkProfile = SharedPreferencesHelper(this@MainActivity).isBlinkProfile()
    }

    override fun onStart() {
        super.onStart()
        if (!isBlinkProfile) {
            binding.userBlink.bringToFront()
            binding.userBlink.isVisible = true
            Handler(Looper.getMainLooper()).postDelayed({
                binding.userBlink.clearAnimation()
                val anim = AlphaAnimation(1.0f, 0.0f)
                anim.setDuration(500)
                anim.startOffset = 0
                anim.repeatMode = Animation.REVERSE
                anim.setRepeatCount(Animation.INFINITE)
                binding.userBlink.startAnimation(anim)
            }, 1000)
        }
    }
    ...
    private fun mainInitialize() {
        ...
        binding.filterIcon.setOnClickListener {
            ...
            popupWindow.animationStyle = R.style.DialogZoomAnimation
        ...
        binding.userIcon.setOnClickListener {
            ...
            val exportData = popupView.findViewById<TextView>(R.id.exportData)
            val importData = popupView.findViewById<TextView>(R.id.importData)
            val deleteAllData = popupView.findViewById<TextView>(R.id.deleteAllData)

            exportData.isVisible = totalAccountCount > 0
            ...
            importData.setOnClickListener {
                if (checkPermission()) {
                    val intent = Intent(this@MainActivity, ImportDataActivity::class.java)
                    val options = ActivityOptions.makeCustomAnimation(
                        this@MainActivity,
                        R.anim.from_right,
                        R.anim.to_left
            ...
            Handler(Looper.getMainLooper()).post {
                if (!isBlinkProfile) {
                    isBlinkProfile = true
                    binding.userBlink.isVisible = false
                    binding.userBlink.clearAnimation()
                    SharedPreferencesHelper(this@MainActivity).setBlinkProfile(true)
                }
            }
        }
...
//                binding.headLayout.visibility = View.VISIBLE
//                binding.mainRecyclerView.visibility = View.VISIBLE
//                binding.categoryLayout.visibility = View.VISIBLE
                totalAccountCount = totalCount
            } else {
//                binding.searchLayout.visibility = View.GONE
//                binding.headLayout.visibility = View.GONE
//                binding.mainRecyclerView.visibility = View.GONE
//                binding.categoryLayout.visibility = View.GONE
                totalAccountCount = 0
            }
    ...
    private fun requestStoragePermission() {
        ActivityCompat.requestPermissions(
            ...
            WRITE_READ_PERMISSION_REQUEST_CODE
        )
    }

    private fun startExportWorker() {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == WRITE_READ_PERMISSION_REQUEST_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, getString(R.string.file_permission_denied), Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
