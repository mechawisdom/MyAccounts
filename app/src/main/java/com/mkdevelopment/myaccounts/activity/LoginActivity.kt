...
import com.mkdevelopment.myaccounts.components.IndicatorView
import com.mkdevelopment.myaccounts.components.PinNumpadView
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!SharedPreferencesHelper(applicationContext).isDisclaimerAccepted()) {
            startActivity(Intent(this@LoginActivity, DisclaimerNoticeActivity::class.java))
            finish()
            return
        }
