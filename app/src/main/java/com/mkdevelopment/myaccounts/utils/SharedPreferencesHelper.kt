...
class SharedPreferencesHelper(
    ...
    init {
        sharedPreferences =
            context.getSharedPreferences("LocalPasswordManager_Data", Context.MODE_PRIVATE)
    }
    ...
    fun isBlinkProfile(): Boolean {
        return sharedPreferences.getBoolean("blink_profile", false)
    }

    fun setBlinkProfile(value: Boolean) {
        val prefsEditor: SharedPreferences.Editor = sharedPreferences.edit()
        prefsEditor.putBoolean("blink_profile", value)
        prefsEditor.apply()
    }
    ...
    fun setDisclaimerAccepted(value: Boolean) {
        val prefsEditor: SharedPreferences.Editor = sharedPreferences.edit()
        prefsEditor.putBoolean("disclaimer_accepted", value)
        prefsEditor.apply()
    }
}