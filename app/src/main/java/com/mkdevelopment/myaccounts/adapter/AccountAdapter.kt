...
class AccountAdapter(
    ...
    override fun onBindViewHolder(holder: AccountViewHolder, position: Int) {
        ...
        if (username.isEmpty() && email.isEmpty()) {
            ...
            holder.binding.textDesc.text = username
            if (email.isNotEmpty()) {
                holder.binding.textSubDesc.visibility = View.VISIBLE
                holder.binding.textSubDesc.text = email
            }
        } else if (email.isNotEmpty()) {
            holder.binding.textDesc.visibility = View.VISIBLE
            holder.binding.textDesc.text = email
            if (phone.isNotEmpty()) {
                holder.binding.textSubDesc.visibility = View.VISIBLE
                holder.binding.textSubDesc.text = phone
            }
        }
